/*
 * SymmetricBreadthFirstFormationSearch.java
 * 
 ...
 */
public class SymmetricBreadthFirstFormationSearch extends BreadthFirstFormationSearch<SymmetricGame, SymmetricMultiAgentSystem, Set<Action>>{
    private Action[] actions;
    private SymmetricRationalizableFinder rationalizableFinder;
    private double tolerance;

    public SymmetricBreadthFirstFormationSearch(SymmetricGame base, SymmetricRationalizableFinder rationalizableFinder, int maxQueueSize, double tolerance) {
    ...
    public SymmetricBreadthFirstFormationSearch(SymmetricGame base, SymmetricRationalizableFinder rationalizableFinder) {
        this(base, rationalizableFinder, 1e-8);
    }

    public SymmetricBreadthFirstFormationSearch(SymmetricGame base, SymmetricRationalizableFinder rationalizableFinder, int maxQueueSize) {
        this(base, rationalizableFinder, maxQueueSize, 1e-8);
    }

    public SymmetricBreadthFirstFormationSearch(SymmetricGame base, SymmetricRationalizableFinder rationalizableFinder, double tolerance) {
