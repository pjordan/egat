 ...
 */
public class StrategicBreadthFirstFormationSearch extends BreadthFirstFormationSearch<StrategicGame, StrategicMultiAgentSystem, Map<Player, Set<Action>>> {
    private Player[] players;
    private Action[][] actions;
    private StrategicRationalizableFinder rationalizableFinder;
    private double tolerance;

    public StrategicBreadthFirstFormationSearch(StrategicGame base, StrategicRationalizableFinder rationalizableFinder, int maxQueueSize, double tolerance) {
    ...
    public StrategicBreadthFirstFormationSearch(StrategicGame base, StrategicRationalizableFinder rationalizableFinder, int maxQueueSize) {
        this(base, rationalizableFinder, maxQueueSize, 1e-8);
    }

    public StrategicBreadthFirstFormationSearch(StrategicGame base, StrategicRationalizableFinder rationalizableFinder) {
        this(base, rationalizableFinder, Integer.MAX_VALUE);
    }

    public StrategicBreadthFirstFormationSearch(StrategicGame base, StrategicRationalizableFinder rationalizableFinder, double tolerance) {
    ...
    protected void initialNodes(StrategicGame base,
                                Queue<FormationSearchNode<StrategicGame, Map<Player, Set<Action>>>> queue,
                                Map<Map<Player, Set<Action>>, FormationSearchNode<StrategicGame, Map<Player, Set<Action>>>> nodes,
                                StrategicMultiAgentSystem bound) {
        int total = 1;
        for (Action[] a : actions) {
            total *= a.length;
        }
